/**
 * GET /og/insight/kuru-improvement
 *
 * Delta insight card: "Kuru Exchange MON/USDC dropped 35% conflicts per
 * block week-over-week, comparing two FULL completed weeks (May 4-11
 * vs May 11-18). Apples-to-apples, no partial-week skew."
 *
...
export async function GET(req: Request) {
  ...
  const cardData: DeltaCardData = {
    ...
    headline: "−35.4%",
    subline:
      "Kuru's MON/USDC market just shed a third of its per-block contention.",
    before: {
      label: "WEEK OF MAY 4",
      stats: ["1.73M conflicts", "2.6 per block"],
    },
    after: {
      label: "WEEK OF MAY 11",
      stats: ["993K conflicts", "1.7 per block"],
    },
    caption:
      "737,687 fewer conflicts in 7 days. Comparing two full weeks, no partial-week noise. The cleanest mover this week.",
    footer: { host, path: "/contract/0x065c9d28e428a0db40191a54d33d5b7c71a9c394" },
  };
  ...
  if (wantsPng) {
    ...
    return new Response(buf, {
      ...
      headers: {
        ...
        "content-disposition": `inline; filename="pev-kuru-improvement-${w}.png"`,
      },
    });
  }
  ...
  return imageResponseAsJpeg(png, {
    headers: {
      "cache-control": "public, max-age=86400, stale-while-revalidate=604800",
      "content-disposition": `inline; filename="pev-kuru-improvement-${w}.jpg"`,
    },
  });
}
